...
class Harness:
    ...
    def connect(self, from_name: str, from_pin: Tuple[int, str], via_name: str, via_wire: Tuple[int, str], to_name: str, to_pin: Tuple[int, str]) -> None:
    ...
    def create_graph(self) -> Graph:
        ...
        dot.attr('graph', rankdir='LR',
                 ranksep=f'{self.options.rank_sep}',
                 bgcolor=wv_colors.translate_color(self.options.bgcolor, "HEX"),
                 nodesep=f'{self.options.node_sep}',
        ...
        for cable in self.cables.values():
            ...
            for connection in cable.connections:
                ...
                if connection.from_port is not None:  # connect to left
                    ...
                    if from_connector.show_name and not cable.simple:
                ...
                if connection.to_port is not None:  # connect to right
                    ...
                    if to_connector.show_name and not cable.simple:
    ...
    def output(self, filename: Tuple[str, Path], view: bool = False, cleanup: bool = True, fmt: tuple = ('pdf', )) -> None:
        # graphical output
        graph = self.create_graph()
        for f in fmt:
            graph.format = f
